...
TEST_CASE("Theme presets exist", "[style]") {
    ...
    REQUIRE(std::find(presets.begin(), presets.end(), "default") != presets.end());
    REQUIRE(std::find(presets.begin(), presets.end(), "dracula") != presets.end());
    REQUIRE(std::find(presets.begin(), presets.end(), "monokai") != presets.end());
}
