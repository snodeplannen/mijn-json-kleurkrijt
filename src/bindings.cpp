...
PYBIND11_MODULE(colored_json, m) {
  ...
  py::class_<colored_json::Color>(m, "Color",
      ...
      .def_static("from_rgb", &colored_json::Color::fromRgb, py::arg("r"),
                  py::arg("g"), py::arg("b"),
                  R"doc(
  ...
  py::class_<colored_json::Style>(m, "Style",
      ...
      .def_readwrite("string_quote_color",
                     &colored_json::Style::string_quote_color,
                     "Kleur voor aanhalingstekens rond strings")
      .def_property(
          "key_colors",
          [](colored_json::Style &s) -> colored_json::KeyColorsMap & {
            return s.key_colors;
          },
          [](colored_json::Style &s, const colored_json::KeyColorsMap &v) {
            s.key_colors = v;
          },
          "Dictionary voor individuele key kleuren (key -> Color)")
      .def_property(
          "value_colors",
          [](colored_json::Style &s) -> colored_json::ValueColorsMap & {
            return s.value_colors;
          },
          [](colored_json::Style &s, const colored_json::ValueColorsMap &v) {
            s.value_colors = v;
          },
          "Dictionary voor individuele value kleuren (path -> Color)")
      .def("set_key_color", &colored_json::Style::setKeyColor, py::arg("key"),
           py::arg("color"),
           R"doc(
      ...
      .def_readwrite(
          "compact", &colored_json::Style::compact,
      ...
      .def_property_readonly(
          "rules_length",
          [](const colored_json::Style &s) { return s.rules.size(); })
  ...
  py::class_<colored_json::Printer>(m, "Printer",
      ...
      .def(py::init<const colored_json::Style &>(), py::arg("style"),
           R"doc(
      ...
      .def("print", &colored_json::Printer::print, py::arg("obj"),
           R"doc(
  ...
  m.def(
      "print",
      [](py::handle obj, const colored_json::Style &style) {
  ...
  m.def(
      "format",
      [isJsonString](py::handle obj, const colored_json::Style &style) {
  ...
  m.def(
      "format_from_json",
      [](const std::string &json_str, const colored_json::Style &style) {
        py::gil_scoped_release release;
        colored_json::Printer printer(style);
        return printer.printFromJson(json_str);
      },
  ...
  py::class_<colored_json::HtmlPrinter>(m, "HtmlPrinter",
      ...
      .def(
          "print",
          [isJsonString](colored_json::HtmlPrinter &self, py::handle obj,
            ...
            if (isJsonString(obj)) {
              std::string json_str = py::str(obj);
              py::gil_scoped_release release;
              return self.printFromJson(json_str, title, background_color,
                                        font_family);
            } else {
              return self.print(obj, title, background_color, font_family);
            }
          },
          py::arg("obj"), py::arg("title") = "Colored JSON",
  ...
  m.def(
      ...
      [isJsonString](py::handle obj, const colored_json::Style &style,
        ...
        if (isJsonString(obj)) {
          std::string json_str = py::str(obj);
          py::gil_scoped_release release;
          return printer.printFromJson(json_str, title, background_color,
                                       font_family);
        } else {
  ...
  m.def(
      "to_html_from_json",
      [](const std::string &json_str, const colored_json::Style &style,
         const std::string &title, const std::string &background_color,
         const std::string &font_family) {
        py::gil_scoped_release release;
        colored_json::HtmlPrinter printer(style);
        return printer.printFromJson(json_str, title, background_color,
  ...
  py::class_<colored_json::MarkdownPrinter>(m, "MarkdownPrinter",
      ...
      .def(
          "print",
          [isJsonString](colored_json::MarkdownPrinter &self, py::handle obj,
                         const std::string &title,
      ...
      .def(
          ...
          [isJsonString](colored_json::MarkdownPrinter &self, py::handle obj,
            ...
            if (isJsonString(obj)) {
              std::string json_str = py::str(obj);
              py::gil_scoped_release release;
              return self.printHtmlFromJson(json_str, title, background_color,
                                            font_family);
            } else {
  ...
  m.def(
      ...
      py::arg("obj"), py::arg("style") = colored_json::Style{},
      py::arg("title") = "Colored JSON", py::arg("language") = "json",
      R"doc(
  ...
  m.def(
      ...
      [isJsonString](py::handle obj, const colored_json::Style &style,
        ...
        if (isJsonString(obj)) {
          std::string json_str = py::str(obj);
          py::gil_scoped_release release;
          return printer.printHtmlFromJson(json_str, title, background_color,
                                           font_family);
        } else {
