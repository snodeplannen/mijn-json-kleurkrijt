...
public:
  ...
  std::string printHtml(
      py::handle obj, const std::string &title = "Colored JSON",
    ...
    output << "<pre style=\"margin: 0; white-space: pre-wrap; word-wrap: "
              "break-word;\">";
  ...
  std::string printFromJson(const std::string &json_str,
                            const std::string &title = "Colored JSON",
                            const std::string &language = "json") {
    output.str("");
    output.clear();
    indent_level = 0;
